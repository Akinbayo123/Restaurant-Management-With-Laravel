                ...
                <td
                    ...
                    <a href="{{ route('edit_category',$item->id )}}"
                      class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-lg  text-white">Edit</a>
                        <form class="px-4 py-2 bg-red-500 hover:bg-red-700 rounded-lg text-white" method="POST" action="{{ url("category/delete", $item->id) }}" onsubmit="return confirm('Are you sure?');">
                         @csrf
                        @method('DELETE')
